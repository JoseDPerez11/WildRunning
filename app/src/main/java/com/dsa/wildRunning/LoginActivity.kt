...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        manageButtonLogin()
        //cada que se cambie lo que se escribe en el edittext de email llama a la función manageButtonLogin
    ...
    public override fun onStart() {
        super.onStart()
        //obtener datos de sesiones anteriores iniciadas
            ...
            .addOnCompleteListener(this){ task ->
                if (task.isSuccessful) goHome(email, "email")
                    ...
                    if (lyTerms.visibility == View.INVISIBLE) {
                        ...
                        Toast.makeText(this, "se ha hecho visible :(", Toast.LENGTH_SHORT).show()
                    }
                    else {
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    //instancia que permite acceder a la base de datos
